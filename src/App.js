    ...
    const renderInputForm = () => {
        ...
        return (
            <div className="form-container">
                ...
                <input type="text" value={record} placeholder="what's cool about you" onChange={(e) => setRecord(e.target.value)} />
        ...
        <div className="App">
            <div className="container">
                <div className="header-container">
                    <header>
                        <div className="left">
                            <p className="title">🗿📈 Skynet Name Service</p>
                            <p className="subtitle">Your immortal Robot on the blockchain!</p>
                        </div>
